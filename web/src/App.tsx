    ...
    return (
      ...
      <form onSubmit={(e: React.SyntheticEvent) => {
        ...
        xhr.onload = function () {
          ...
          xhr.onload = function () {
            srs(xhr.response);
            svd(xhr.response.visibleDates.dates.map((a: Record<"value", string>) => a.value));
          };
        };
      }}>
        <div>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    xhr.onload = function () {
      ...
      setVisibleDates(xhr.response.visibleDates.dates.map((a: Record<"value", string>) => a.value));
    };
  }, []);
